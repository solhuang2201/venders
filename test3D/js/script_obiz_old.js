(function () {
  ...
  function init() {
    ...
    const MODEL_PATH = 'http://themes.show.bis.tw/3D/Interactive3DCharacter/js/OBiz_motion_A_V02_04.glb';
    ...
    function (gltf) {
      ...
      model.traverse(o => {
        ...
        // 引用頸部和腰部骨骼
        if (o.isBone && o.name === 'OBiz_V02_05BizHead') {
          neck = o;
        }
        if (o.isBone && o.name === 'OBiz_V02_05Spine') {
          waist = o;
        }
      });
      ...
      let clips = fileAnimations.filter(val => val.name !== 'fly');
      ...
      let idleAnim = THREE.AnimationClip.findByName(fileAnimations, 'fly');
  ...
  function raycast(e, touch = false) {
    ...
    if (intersects[0]) {
      ...
      if (object.name === 'OBiz_V02_05head_V12') {
